...
test('vertical tabs expose one category and support arrow, Home, End and Tab keys', async ({ page }) => {
    ...
    await expect(page.getByRole('tab', { name: 'Visualization', exact: true })).toBeFocused()
    await expect(page.getByRole('tab', { name: 'Visualization', exact: true })).toHaveAttribute('aria-selected', 'true')
    ...
    await page.selectOption('#state-noteArrangement', 'guitar')
    await page.getByRole('tab', { name: 'Visualization', exact: true }).focus()
